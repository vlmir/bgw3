...
#isql-v exec="ld_dir('uploads/tfac2gene', '*nt.gz', 'http://rdf.biogateway.eu/graph/tfac2gene');"
#isql-v exec="ld_dir('uploads/reg2targ', '*nt.gz', 'http://rdf.biogateway.eu/graph/reg2targ');"
#isql-v exec="ld_dir('uploads/reg2pway', '*nt.gz', 'http://rdf.biogateway.eu/graph/reg2targ');" # do be removed
#isql-v exec="ld_dir('uploads/tad', '*.nt.gz', 'http://rdf.biogateway.eu/graph/tad');"
#isql-v exec="ld_dir('uploads/crm', '*.nt.gz', 'http://rdf.biogateway.eu/graph/crm');"
#isql-v exec="ld_dir('uploads/crm2phen', '*.nt.gz', 'http://rdf.biogateway.eu/graph/crm2phen');"
#isql-v exec="ld_dir('uploads/crm2tfac', '*.nt.gz', 'http://rdf.biogateway.eu/graph/crm2tfac');"
#isql-v exec="ld_dir('uploads/p-crm2gene', '*.nt.gz', 'http://rdf.biogateway.eu/graph/crm2gene');"
